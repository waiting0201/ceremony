...
│ 頁標題                          [← 返回]       │
├────────────────────────────────────────────────┤
│ 列印不正常時：[印表機設定][自動選紙:開] [診斷] │  ← 桌面版限定，永遠在
├────────────────────────────────────────────────┤
│ ┃ 單筆列印 ┃ 批次列印  ← tab 切換             │
...
**為何列印排障列在最上面而不是收進 toolbar**（2026-08-11）：那條 toolbar 只在產出 PDF 後才存在，
