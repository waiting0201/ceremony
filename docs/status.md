...
last_updated: 2026-07-06 (薦牌亡者/陽上矩陣同欄上下排姓名間補全形空白間距；先前新增 GET /reports/tablet/sample dev-only 端點：5 亡者+5 陽上固定樣本，免 signupId；2026-07-05 薦牌 OneOne 變體 Number/陽上/亡者 Y 座標修正 2cm Margin 偏移；debugOverlay 改用 page.Background()；亡者中心線置中)
