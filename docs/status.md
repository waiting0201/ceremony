...
- [x] **發版 v2.5.0** — Done 2026-08-17
  ...
  - ⏳ **待實機/實體複驗（已跨多版順延，複驗時一併清）**：文牒兩項與資料卡 3+ 位不縮字的**實體套印**；決策 11 Phase 1 的六報表對照組；v2.4.6～v2.4.10 順延未驗的項目。
