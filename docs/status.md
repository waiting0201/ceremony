...
- [x] **發版 v2.5.1** — Done 2026-08-18
  ...
  - ⏳ **待實機**：[workflows/pending-verification.md](workflows/pending-verification.md) **B12（要先做）**、**B13**、B10、B11。⚠️ B12 任何一台印表機都驗得到，不必等 PA2000——**它沒過就代表 STA 不是唯一根因**。
