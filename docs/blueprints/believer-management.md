...
last_updated: 2026-07-31 (地址與堂號可整段清空：移除本表單遺留的 mailAddress Validators.required〔後端自 2026-07-21 已允許空〕，寄件/文牒地址含城市與郵遞區號、堂號皆可刪，B15 結案；同日先前地址區改版比照報名表單：拆「寄件地址」「文牒地址」兩個 fieldset、框內欄位標題全拿掉改 placeholder、「同寄件地址」勾選移進文牒框內靠右；同日「同寄件地址」觸發門檻放寬為「城市/區域/地址三者全空才擋」。先前 2026-07-21 (往生／陽上名單字級對齊地址，比照報名表單客訴))
---
...
4. 點選列 → 右側編輯區帶入該信眾資料
5. 修改 → 「確認」→ 成功「修改信眾成功！」
6. 新增（清空編輯區）→ 填寫姓名（必填）+ 寄件地址（**非必填**，2026-07-21 起）+ 其他 →「確認」→ 成功「新增信眾成功！」
