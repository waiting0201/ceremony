...
→ **任何改動 `frontend/electron/print-options.ts` 的 PR，都等於作廢本檔的全部驗收，必須連同
重新實機對位一起做。** 送印基準的契約見 [print-channel-electron.md](print-channel-electron.md)。
