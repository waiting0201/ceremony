...
last_updated: 2026-07-17 (§3 薦牌 3+ 亡/3-6 陽矩陣改「方框內動態排版」＋編號 Left 0.5：使用者以 reference/薦牌.jpg 手寫量測指定，取代固定列距+WithBottomGap；先前 §20 普桌資料卡 worshipcard；OneOne 2cm Margin 補償；頁高 25.5cm；亡者中心線水平置中)
---
