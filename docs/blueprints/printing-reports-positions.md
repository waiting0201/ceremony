...
> 3. **往者整體右移 0.1cm**：排版中心線 `DeadCenterX 5.685 → 5.785`（1 位置中／2 位左右分居／3+ 位 2×3 矩陣皆以此中心線推算，移一個常數即整體右移）。右移後 3+ 矩陣右欄右緣 ≈7.018cm 仍在窗框內緣 7.163cm 之內（安全）。往者 Top 不變（僅水平位移）。
