...
last_updated: 2026-07-04 (新增 §20 普桌資料卡 worshipcard：非 RDLC、樣板量測錨值 + 墨跡仿射映射公式 + 右側欄位座標；先前 §3 亡者/陽上矩陣同欄上下排姓名間補一個全形空白間距，不動座標；先前 OneOne 變體 Number/陽上/亡者 2cm Margin 補償；頁高 25.5cm；亡者中心線水平置中)
---
