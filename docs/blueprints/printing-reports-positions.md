...
>
> 🛑 **2026-08-05 使用者指定：薦牌列印位置「整個左移 2.5cm」——已實作，但實測結果是編號與陽上整組印不出來，等使用者確認後才能上線**，實作 [TabletRenderer.cs](../../backend/src/Ceremony.Infrastructure/Reporting/TabletRenderer.cs)：
